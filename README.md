...
| 이름   | 역할                          | 담당 업무                                                                 | GitHub |
|--------|-------------------------------|---------------------------------------------------------------------------|--------|
| 김지우 | 백엔드 개발 / 인프라 구축 / 전체 설계 | - API 설계 및 개발 <br> - DB 모델링 <br> - CI/CD 구축 <br> - 서버 아키텍처 설계 및 인프라 구축 | [jiubuntu](https://github.com/jiubuntu) |
| 김희수 | 프론트엔드 개발 / UI/UX 설계        | - React 화면 및 기능 개발 <br> - Figma 디자인 및 UI/UX 설계 <br> - 사용자 기능 구현 | [KimHeeH](https://github.com/KimHeeH) |
