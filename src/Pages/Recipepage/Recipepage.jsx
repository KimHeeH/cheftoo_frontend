      ...
      <div className="font-pretendard">
        <div className="max-w-[1100px]  px-8 lg:p-20 mx-auto  mb-5 lg:h-[70px]">
          <div className="flex gap-2 lg:gap-4 mt-4 w-full lg:mt-0  h-[48px] lg:h-[70px] mb-8 ">
            ...
            <div
              ...
              className=" text-xs lg:text-xl cursor-pointer flex lg:pl-8 gap-2 lg:gap-4 items-center relative rounded-r-[10rem] rounded-l-none w-[100px] lg:w-[150px] bg-brand text-white "
            >
              {" "}
              검색
        ...
        <div>
          <div className="mx-auto max-w-[1700px] flex lg:pt-10 flex-col  justify-center w-full px-8 mb-28 ">
            ...
            <div></div>
            <div className="border-t pt-4  grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-10 w-full lg:max-w-[1700px]  lg:pb-[80px]">
