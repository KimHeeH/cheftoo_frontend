  ...
  return (
    <div className="mt-4 relative overflow-x-hidden overflow-y-auto lg:mt-16 lg:mb-24 ">
      ...
      <div className="text-center mt-10">
        <h1 className="font-gowun text-4xl lg:text-4xl font-bold  mb-4 animate-fade-in">
          오늘의 레시피를 찾아보세요!
        </h1>
        <p className="text-2xl font-gowun text-gray-500 mb-6">
          당신의 요리를 공유하고, 새로운 레시피를 발견해보세요.
        </p>
        <button className="flex items-center gap-2 mx-auto mt-4 bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 rounded-full shadow-md transition">
      ...
      <div className="container mt-12 mb-6">
        <h2 className="text-2xl lg:text-3xl font-bold"> 인기 레시피</h2>
